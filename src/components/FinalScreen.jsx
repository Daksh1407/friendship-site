...
export default function FinalMessageScreen() {
  ...
  const messages = [
    ...
    "No matter what life brings, I’ll always be here to stand by your side🤝🎉",
    "You're not just a friend, you're my priority — yesterday, today and tomorrow!💖",
    "Even in silence, I’ll be the one who understands you the most. 💫",
    "The fear of losing you reminds me how deeply I value our bond. 🌙",
